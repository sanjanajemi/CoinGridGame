...
class GameTest {
  ...
  @Test def test_19_playeratcoin(): Unit = {
    var game: Game = GameBuilder.initialiseGame3()
  ...
  @Test def test_41_maxpoints(): Unit = {
    var game: Game = GameBuilder.initialiseGame1()
  ...
  @Test def test_42_maxpoints(): Unit = {
    var game: Game = GameBuilder.initialiseGame2()
    game.move("ddds")
  ...
  @Test def test_43_maxpoints(): Unit = {
    var game: Game = GameBuilder.initialiseGame2()
    game.move("ddds")
    assertEquals(40, game.maxPoints())
    assertEquals(20, game.getPoints)
  ...
  @Test def test_44_maxpoints(): Unit = {
    var game: Game = GameBuilder.initialiseGame2()
    game.move("dss")
    assertEquals(40, game.maxPoints())
    assertEquals(20, game.getPoints)
  ...
  @Test def test_48_checkcoins(): Unit = {
    var game: Game = GameBuilder.initialiseGame1()
    game.move("ssssdddd")
    assertEquals(0, game.getPoints)
    assertEquals((4,4), game.getPlayerPos)
  ...
  @Test def test_49_checkcoins(): Unit = {
    var game: Game = GameBuilder.initialiseGame1()
    game.save()
    game.move("sssddd")
    //assertEquals((-1,-1), game.getSavePos)
